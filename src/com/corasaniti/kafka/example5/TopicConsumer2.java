...
public class TopicConsumer2 {
    ...
    private static final String GROUP_ID = "demojava2-groupb";
    ...
    public static void main(String[] args) throws Exception     
    {
        ...
        consumer2.subscribe(Collections.singleton(TOPIC_NAME));

        System.out.printf("Consumer2 waiting for message... ");
        while (true) {
            ConsumerRecords<String, String> records1 = consumer2.poll(Duration.ofMillis(100));
            for (ConsumerRecord<String, String> record : records1) {
            	try {
                    ...
                    System.out.printf("Consumer2 Received message: id=%s, message=%s, time=%s, DateTime=%s\n", 
                    		   		   messageTime.id, 
                    		   		   messageTime.message, 
